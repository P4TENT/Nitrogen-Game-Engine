...
public:
		...
		: Layer("Example"), m_Camera(-1.6f, 1.6f, -0.9f, 0.9f), m_CameraPosition(glm::vec3(0.f))
	{
		...
		m_Texture2d = Nitrogen::Texture2D::Create("D:\\Code\\C++\\Nitro\\Sandbox\\assets\\textures\\2.png");
		m_TransparentTex = Nitrogen::Texture2D::Create("D:\\Code\\C++\\Nitro\\Sandbox\\assets\\textures\\transparent.png");
