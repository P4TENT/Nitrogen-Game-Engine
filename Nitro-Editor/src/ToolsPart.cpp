...
void Nitrogen::ToolsPart::NoProjectSelectedPopup()
{
...
namespace Nitrogen {
    std::string ToolsPart::OpenProject()
    {
        {
    ...
    void ToolsPart::ConsoleTab(const std::string& logFilePath)
    {
    ...
    // PRIVATE
    void ToolsPart::RunCommandInThread(const std::string& command)
    {
    ...
    void ToolsPart::DisplayDirectoryTree(const std::filesystem::path& directory)
    {
